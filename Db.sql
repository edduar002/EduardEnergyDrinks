...
SELECT ID, CODE, NAME, SURNAME, PHONE, EMAIL, PASSWORD, IMAGE
FROM users;
...
SELECT ID, NAME, PRICE, UNITS, CONTENT, STOCK
FROM products;

CREATE OR REPLACE VIEW DIRECTIONS_LIST_MANAGEMENT AS
SELECT ID, CARRER, STREET, POSTAL_CODE, DIRECTION 
FROM directions;

CREATE OR REPLACE VIEW PAYS_LIST_MANAGEMENT AS
SELECT ID, ELECTION, NUMBER_ELECTION
FROM pays;
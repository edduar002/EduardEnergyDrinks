        ...
        public function windowUpdate(){
            ...
            if(isset($_GET)){
                ...
                /*De lo contrario*/     
                    ...
                    Helps::createSessionAndRedirect("erroreditar", "Ha ocurrido un error al cargar la ventana", "?controller=userController&action=managementPurchasingStatus");
                }
            /*De lo contrario*/      
            }else{
                /*Crear la sesion y redirigir a la ruta pertinente*/
                Helps::createSessionAndRedirect("erroreditar", "Ha ocurrido un error inesperado", "controller=userController&action=managementPurchasingStatus");
            }
        }
        ...
        public function register(){
            ...
            if(isset($_POST)){
                ...
                if($user_id && $name){
                    ...
                    $resultado = $model->registerPurchasingStatus($user_id, 1, $name, $created_at2);
                    /*Comprobar si el registrado ha sido exitoso*/                    
                    if($resultado != false){
                        /*Crear la sesion y redirigir a la ruta pertinente*/
                        Helps::createSessionAndRedirect("aciertoregistro", "Se ha registrado exitosamente el estado de la compra", "?controller=userController&action=managementPurchasingStatus");
                    /*De lo contrario*/  
                    }else{
                        /*Crear la sesion y redirigir a la ruta pertinente*/
        ...
        public function update(){
            ...
            if(isset($_GET)){
                ...
                if($purchasing_status_id){
                    ...
                    if($resultado){
                        /*Crear la sesion y redirigir a la ruta pertinente*/
                        Helps::createSessionAndRedirect("aciertoactualizar", "La actualizacion del estado de la compra se ha realizado con exito", "?controller=userController&action=managementPurchasingStatus");
                    /*De lo contrario*/    
                    }else{
                        /*Crear la sesion y redirigir a la ruta pertinente*/
